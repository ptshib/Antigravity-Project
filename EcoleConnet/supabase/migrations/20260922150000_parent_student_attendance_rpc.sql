-- Migration : RPC sécurisée de consultation des présences parent
-- Fichier : supabase/migrations/20260922150000_parent_student_attendance_rpc.sql
...
BEGIN
  ...
  IF v_evaluated_sessions > 0 THEN
    v_attendance_rate := pg_catalog.round(
